...
#define INCLUDE_PICTUREBOX /* calendar needs this */
...
/* set this to 1 to get 0.7b/older style window list, 0 for 0.7c style */
#define CLASSIC_WINDOW_NUMBERING 0
...
#if CLASSIC_WINDOW_NUMBERING	/* new decision point 0.7c */
	/* no extra work */
#else
...
void UpCaseMarked(WINDOW);		/* new 0.7d */
void DownCaseMarked(WINDOW);		/* new 0.7d */
void StatsForMarked(WINDOW, unsigned *, unsigned *, unsigned *); /* new 0.7d */
